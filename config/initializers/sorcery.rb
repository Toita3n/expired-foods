...
Rails.application.config.sorcery.configure do |config|
  ...
  # config.salesforce.user_info_mapping = {:email => "email"}
   ...
   config.line.key = Rails.application.credentials.line[:login_channel_id]
   config.line.secret = Rails.application.credentials.line[:login_secret]
   config.line.callback_url = Rails.application.credentials.line[:callback]
